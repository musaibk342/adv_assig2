...
mongodb.connect(
  "mongodb+srv://hammer:ham@clusterp.rg4la.mongodb.net/gymusers?retryWrites=true&w=majority",
  (error, result) => {
    if (error) {
...
app.use((req, res, next) => {
  // middleware common for all the paths
...
app.use("/home", (req, res, next) => {
  // middleware only for the /home path
